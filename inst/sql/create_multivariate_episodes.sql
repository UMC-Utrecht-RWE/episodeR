...
--        INTERVAL '1 day'
--     )) AS dates
--      FROM read_parquet('data/D3_study_variables/D3_UNIVARIATE_EPISODES_parquet/**/*.parquet', hive_partitioning = TRUE);
...
--     FROM (
--         SELECT *
--         FROM read_parquet('data/D3_study_variables/D3_UNIVARIATE_EPISODES_parquet/**/*.parquet', hive_partitioning = TRUE) episodes
